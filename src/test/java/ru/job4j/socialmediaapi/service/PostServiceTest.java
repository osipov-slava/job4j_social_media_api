...
public class PostServiceTest {
    ...
    public void whenFindByUserIdsThenPostDtosByUser() {
        User user1 = new User(1L, "John", "John@mail.com", "pass", null, null);
        User user2 = new User(2L, "Kate", "Kate@mail.com", "pass", null, null);
        ...
        UserPostsDto userPostsDto1 = new UserPostsDto(1L, "John@mail.com", List.of(
                new PostDto(1L, "title1", null, null, true, "John@mail.com", "Kate@mail.com"),
                new PostDto(2L, "title2", null, null, true, "John@mail.com", "Kate@mail.com")));
        UserPostsDto userPostsDto2 = new UserPostsDto(2L, "Kate@mail.com", List.of(
                new PostDto(3L, "title3", null, null, true, "Kate@mail.com", "John@mail.com"),
                new PostDto(4L, "title4", null, null, true, "Kate@mail.com", "John@mail.com")));
